...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, CALPROG, CALVER3, calprog_3, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALPROG, CALVER3, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALPROG, CALVER3, calprog_3, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALPROG, CALVER3, tcp).");
		exit(1);
	}
